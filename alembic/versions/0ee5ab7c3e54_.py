...
def upgrade():
    ...
    sa.Column('position_data_id', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('position_data_id')
    )

    op.create_unique_constraint('uq_position_data', 'raw_data', ['Id', 'TimeStamp'])
